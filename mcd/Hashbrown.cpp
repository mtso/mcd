...
//    for (int i = 0; i < 4; ++i) {
//        local = ((local << 1) | (local >> 3));
//        cout << (local & 1);
//    }
//}
//void printLongLong(const uint64_t& number)
//{
//    uint64_t local = number;
//    for (int i = 0; i < 64; ++i) {
//        local = ROL64(local, 1);
//        cout << (local & 1);
//    }
//}
//
//void printLong(const uint32_t& number)
//{
//    uint32_t local = number;
//    for (int i = 0; i < 32; ++i) {
//        local = ROL32(local, 1);
//        cout << (local & 1);
//    }
...
//{
//    unsigned char local = ch;
//    for (int i = 0; i < 8; ++i) {
//        local = local << 1 | local >> 7;
//        cout << (local & 1);
//    }
//}
//
//void printChunkL(const uint32_t* block)
//{
//    for (int i = 0; i < CHUNKUL_SIZE; i+=1)
//    {
//        printLong(block[i]);
//        cout << ' ';
//    }
//}
//void printChunkXt(const uint32_t* block)
//{
//    for (int i = 0; i < CHUNKXT_SIZE; i+=1)
//    {
//        printLong(block[i]);
//        cout << " ";
//    }
//}
//void printChunkCh(const unsigned char block[CHUNKCH_SIZE]) {
//    for (int i = 0; i < CHUNKCH_SIZE; i++) {
//        printChar(block[i]);
//        cout << " ";
//    }
//}
